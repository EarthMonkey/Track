...
<div class="nav_bar">
    ...
    <div class="navs">
        ...
        <div class="nav active"
             onclick="window.location.href='/Track/public/Activity/{!! $username !!}/{!! $userId !!}'">赛迹
        </div>
        <div class="nav" onclick="window.location.href='/Track/public/History/{!! $username !!}/{!! $userId !!}'">足迹
        </div>
        <div class="nav" onclick="window.location.href='/Track/public/Social/{!! $username !!}/{!! $userId !!}'">人迹
        </div>
    </div>
